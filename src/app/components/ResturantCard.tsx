...
function ResturantCard(props: ResturantCardProps) {
    ...
    return (
      <div className={`shadow-lg transition-transform duration-200 ease-in-out ${isClicked ? 'scale-105' : 'hover:scale-105'}`} style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '16rem', height: '23rem', borderRadius: '1rem', border: `2px solid  ${props.borderColor}`, margin: '0.75rem', backgroundColor: 'white'}}
      onClick={handleClick}>
